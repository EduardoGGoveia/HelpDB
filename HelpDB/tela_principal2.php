...
<body>
  ...
  <div class="container-md border border-2 rounded-4 text-center mt-1 py-3" style="max-width: 800px">
    ...
    <div class="d-grid gap-2 col-8 mx-auto py-2" style="max-width: 350px">
      <button type="button" class="btn" id="button1" data-bs-toggle="modal" data-bs-target="#modal-perguntar">Perguntar</button>
      <!--Modal-Perguntar-->
      <div class="modal fade" id="modal-perguntar" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">Qual a sua dúvida?
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body align-items-center">
            <textarea class="form-control" style="height: 150px" id="cpPerguntar" name="cpPerguntar"></textarea>
          </div>
          <div class="modal-footer">
            <div class="row">
              <div class="col-md">
                <select required class="form-select" aria-label="Default select example" id="catPer" name="catPer">
            ...
            <button type="submit" class="btn" id="button1">Perguntar</button>
          </div>
        </div>
      </div>
      </div>
  ...
  <div class="row justify-content-end border-top pt-1"> 
    <div class="col-sm-auto py-1">
      <div class="dropdown">
        <a class="btn border border-1 dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: rgb(255, 255, 255); ">
          Categorias
        </a>
        <ul class="dropdown-menu">
    ...
    <div class="col-sm-auto py-1">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="tela_principal2.php">Sem Respostas</a></li>
          <li><a class="dropdown-item" href="v_res.php">Respondidas</a></li>
        </ul>
      </div>
    </div>
  </div>
        ...
        echo'<div class="row d-flex flex-column">';
          ...
          echo'<div class="col text-end">';
            echo'<button class="btn">
              ...
              <a href="responder.php?idpergunta='.$dado['idpergunta'].'" class="btn" id="button2">Responder</a>';
          echo'</div>';
        echo'</div><hr>';
        }
      }

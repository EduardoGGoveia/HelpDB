...
<body>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <!--Fim do Modal-->
                <!-- Preparação para a tabela de respostas do usuário -->
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="col py-3 text-center  justify-content-center align-items-center ">
    <div class="container-fluid rounded-3 pt-2 text-center">
      ...
      <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="tela_perfil.php">Perguntas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="tela_perfil2.php">Respostas</a>
        </li>
      </ul>
      <!-- Aqui começa a tabela de respostas do usuário -->
      <div class='table mt-2'>
        <?php
        if(consultResUs($_SESSION['idusuario'])){
          foreach(consultResUs($_SESSION['idusuario']) as $dados){
            echo'<div class="row d-flex flex-column">';
              ...
              echo'<div class="col text-end">';
                echo'<a href="pergunta.php?idpergunta='.$dados['idpergunta'].'" class="btn" id="button2">Ver pergunta</a>';
              echo'</div>';
            echo'</div><hr>';
          }
        }
  ...
  <!-- Fim das tabelas de respostas do usuário -->
